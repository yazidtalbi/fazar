                  ...
                  >
                    ...
                    >
                      <p className="text-base sm:text-lg leading-relaxed text-[#1B1124] font-normal mt-0 sm:mt-7 ">
                        <span className="font-semibold text-[#e06a35]">Coming soon.</span> Connect with Morocco&apos;s
                      ...
                      >
                        <form onSubmit={handleWaitlistSubmit} className="flex w-full max-w-md items-center space-x-2 bg-white rounded-full p-1.5 border border-neutral-200">
                          <input type="email" name="email" placeholder="Enter your email address" className="flex h-11 w-full bg-transparent px-4 text-sm text-neutral-900 placeholder:text-neutral-500 focus:outline-none" required />
