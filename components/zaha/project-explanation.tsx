    ...
    <div className="bg-background py-12 md:py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">What is OFUS?</h2>
          <Link 
            href="/search" 
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-12 md:mb-16">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              OFUS is an online marketplace where people create, sell, buy, and collect unique items. 
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              OFUS does not have a warehouse but connects millions of individuals who sell what they love. 
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              OFUS places high importance on data confidentiality. 
